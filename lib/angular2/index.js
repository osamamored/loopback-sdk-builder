  ...
  **/
  ...
  function buildServiceImports(model, loadAccessToken, isIo) {
    ...
    let imports = [
      ...
      { module: 'Store2', from: '../../../../app/shared-module/store'},/* aswan */
  ...
  function buildModuleImports(models, isIo, driver) {
    ...
    imports.push({ module: 'Store2', from: '../../app/shared-module/store'}) /*aswan*/
  ...
  function buildServiceDI(isIo) {
    ...
    dependencies = dependencies.concat([
      ...
      '@Inject(Store2) protected store: Store2',/*@aswan*/
  ...
  function buildBaseServiceImports(isIo) {
    let imports = [
      ...
      { module: 'Observable, Subject, Subscription', from: 'rxjs' },
      { module: 'catchError, map, filter, tap, startWith', from: 'rxjs/operators' },/*@aswan*/
      { module: 'Store2', from: '../../../../app/shared-module/store' },/*@aswan*/
    ];
